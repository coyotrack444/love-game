document.getElementById('compatibilityForm').addEventListener('submit', function(event) {
    ...
    if (name1 && name2) {
        ...
        window.location.href = `aaaa valentin game/index.html?name1=${encodeURIComponent(name1)}&name2=${encodeURIComponent(name2)}&compatibility=${compatibilityPercentage}`;
    }
